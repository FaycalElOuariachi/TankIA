...
generator.setBN(gum.loadBN("asia.bif"))
generator.setCommentMode(True)
generator.genere(['lung_cancer?', 'bronchitis?', 'tuberculosis?'],
                 {'dyspnoea?', 'smoking?', 'positive_XraY?', 'visit_to_Asia?'},
                 {'visit_to_Asia?': [0, 1], 'dyspnoea?': [1, 0.5], 'smoking?': [1, 1]},
